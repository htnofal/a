         ...
         <SignIn.Root>
          <SignIn.Step name="start">
            ...
            <div className="text-center space-y-2">
              <h2  className="  text-xl font-medium text-gray-800 mb-4 ">Welcome Back</h2>
            </div>

            <div className="space-y-4">
              
              <Clerk.Field name="identifier" className="space-y-2">
                <Clerk.Input placeholder="Email"
              ...
              <Clerk.Field name="password" className="space-y-2">
               ...
               <SignIn.Action submit
                  className="w-full text-white py-3 rounded-md
                   transition font-semibold text-center cursor-pointer"  style={{ backgroundColor: colors.secondary }}>
                  Login 
                </SignIn.Action>
              <div className="flex justify-end text-sm text-gray-600">
                <SignIn.Action 
                  navigate="forgot-password" 
                  className="font-medium text-indigo-700 hover:underline focus:outline-none focus:underline cursor-pointer">
                  Forgot password?
                </SignIn.Action>
              </div>
             ...
             <Clerk.Connection name="google"
              ...
              <div className="text-center text-sm text-gray-600">
                New to ClickView?{' '}
                <a href="/sign-up" className="font-medium text-indigo-700 hover:underline cursor-pointer">
                  Sign up
                </a>
              </div>
            </div>
